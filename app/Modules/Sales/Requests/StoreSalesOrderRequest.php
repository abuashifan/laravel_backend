...
class StoreSalesOrderRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'down_payment' => ['nullable', 'array'], 'down_payment.deposit_date' => ['required_with:down_payment', 'date'], 'down_payment.cash_bank_account_id' => ['required_with:down_payment', 'integer', 'exists:tenant.chart_of_accounts,id', new PostableAccount], 'down_payment.amount' => ['required_with:down_payment', 'numeric', 'gt:0'], 'down_payment.notes' => ['nullable', 'string'],
