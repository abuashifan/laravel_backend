    ...
    private function seedMasterData(): void
    {
        ...
        if ($this->has('account_mappings')) {
            foreach ([
                ...
                'sales.discount' => ['sales', '4120'],
                'sales.return' => ['sales', '4110'],
                'sales.tax_output' => ['sales', '2120'],
                'sales.customer_deposit' => ['sales', '2130'],
                'sales.default_cash_bank' => ['sales', '1110'],
                'purchase.accounts_payable' => ['purchase', '2100'],
                'purchase.payable' => ['purchase', '2100'],
                'purchase.expense' => ['purchase', '5100'],
                'purchase.default_purchase' => ['purchase', '1130'],
                'purchase.inventory_interim' => ['purchase', '2150'],
                'purchase.tax_input' => ['purchase', '2140'],
                'purchase.discount' => ['purchase', '5110'],
                'purchase.return' => ['purchase', '5110'],
                'purchase.vendor_deposit' => ['purchase', '1140'],
                'purchase.default_cash_bank' => ['purchase', '1110'],
                ...
                'cash_bank.bank_interest_income' => ['cash_bank', '7100'],
                'cash.bank' => ['cash_bank', '1110'],
                'opening_balance.equity' => ['opening_balance', '3100'],
                'closing.retained_earnings' => ['closing', '3200'],
                'closing.current_year_earnings' => ['closing', '3300'],
                'journal.suspense' => ['journal', '3100'],
            ] as $key => [$module, $code]) {
