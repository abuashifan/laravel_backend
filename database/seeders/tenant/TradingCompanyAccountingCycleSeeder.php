...
class TradingCompanyAccountingCycleSeeder extends Seeder
{
    ...
    private function accountMappings(): array
    {
        return [
            ...
            'fixed_assets.equipment_cost' => ['fixed_assets', '1520', false],
            'fixed_assets.equipment_accumulated_depreciation' => ['fixed_assets', '1521', false],
            'fixed_assets.equipment_depreciation_expense' => ['fixed_assets', '6170', false],
